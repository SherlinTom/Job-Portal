        ...
        {profile ? (
            ...
            <Card.Body>
                <h2 className='text-center pb-3'>Profile</h2>
                    <Row>
                        ...
                        <p><b>Contact No:</b> {profile.contact_no}</p>
                        {
                            profile.role ==='employer' ? (
                                ...
                                <p><b>Company Address:</b> {profile.company_address}</p>
                                </>
                    ...
                    <Button className='btn-md btn-primary border border-light' onClick={()=>navigate('/profile-update')}>Update Profile</Button>
                    </div>
                </Card.Body>
            </Card>
        ):null}
